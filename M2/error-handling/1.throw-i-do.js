...
// throw is more extreme, will stop the entitre program from running if we don't catch and handle the error


// 3. When throw an error in the first test case, does the second test case run? Why or why not?
// hell nah! It crashes the program right when the error is thrown. No downstream code gets executed.
